...
class OrderPageLocators:
  ...
  # Кнопка "Далее" страницы заказа
    ...
    CALENDAR_DATE_TODAY = [By.XPATH, f'//div[contains(@class,"react-datepicker__day--0{DataDay.delivery_day_today}")]']
    CALENDAR_DATE_TOMORROW = [By.XPATH, f'//div[contains(@class,"react-datepicker__day--0{DataDay.delivery_day_tomorrow}")]']
   ...
   #Заказать
    ...
    ORDER_DONE = [By.CSS_SELECTOR, '[class^=Order_ModalHeader]']